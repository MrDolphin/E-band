...
internal static class AppBuildInfo
{
	...
	public static string GetCommitId()
	{
		...
		return SelectCommitId(buildCommit, infoVersion);
	}

	public static string SelectCommitId(
		string buildCommit,
		string informationalVersion)
	{
		if (!string.IsNullOrWhiteSpace(buildCommit))
		{
			return ShortCommit(buildCommit.Trim());
		}

		string infoVersion = informationalVersion;
